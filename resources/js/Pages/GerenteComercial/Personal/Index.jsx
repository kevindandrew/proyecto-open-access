...
function CredencialesNuevoComercial({ credenciales, onCerrar }) {
            ...
            <div className="flex items-start justify-between gap-3">
                <div>
                    <p className="text-sm font-semibold text-[#042753]">
                        Comercial creado — comunicá estos datos, no se van a
                        volver a mostrar
                    </p>
...
export default function Index({ empleados }) {
    ...
    const eliminar = (empleado) => {
        ...
        router.delete(route('gerente-comercial.personal.destroy', empleado.id_empleado));
    };

    return (
        <GerenteComercialLayout header="Comerciales">
            <Head title="Comerciales" />

            <PageHeader
                icon={IconoPersonalNav}
                title="Comerciales"
                subtitle="Las personas del equipo comercial registradas en el sistema"
            >
                <Link
                    ...
                    <tbody className="divide-y divide-gray-100">
                                ...
                                <td className="px-4 py-3">
                                    <div className="flex items-center justify-end gap-1">
                                        <BotonIcono
                                            ...
                                            titulo="Editar"
                                            href={route(
                                                'gerente-comercial.personal.edit',
                        ...
                        {empleados.length === 0 && (
                            <tr>
                                ...
                                >
                                    No hay comerciales registrados todavía.
                                </td>
                            </tr>
                        )}
                    </tbody>
