...
use App\Http\Controllers\GerenteOperativo\TarifaAgenteController;
...
Route::middleware(['auth', 'verified', 'role.empleado:Gerente Comercial'])
    ...
    ->group(function () {
        ...
        Route::get('cotizaciones/tarifas-agente-disponibles', [GerenteComercialCotizacionController::class, 'tarifasAgenteDisponibles'])->name('cotizaciones.tarifas-agente-disponibles');
...
Route::middleware(['auth', 'verified', 'role.empleado:Gerente Operativo'])
    ...
    ->group(function () {
        ...
        Route::resource('tarifas-agente', TarifaAgenteController::class)
            ->parameters(['tarifas-agente' => 'tarifaAgente'])
            ->except(['show']);
        ...
        Route::get('cotizaciones/tarifas-agente-disponibles', [GerenteOperativoCotizacionController::class, 'tarifasAgenteDisponibles'])->name('cotizaciones.tarifas-agente-disponibles');
