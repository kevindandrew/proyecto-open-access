...
class CotizacionController extends Controller
{
    ...
    {
        $cotizaciones = Cotizacion::with(['cliente', 'comercial', 'pol', 'pod', 'detalle:id_detalle,id_cotizacion,moneda,costo_total'])
    ...
    {
        $cotizacion->load(['cliente', 'comercial', 'agenteOrigen', 'navieraAerolinea', 'pol', 'pod', 'contenedores', 'detalle', 'embarques', 'origen', 'continuaciones']);
    ...
    public function edit(Cotizacion $cotizacion): Response
    {
        ...
        return Inertia::render('GerenteOperativo/Cotizaciones/Editar', [
            'cotizacion' => [
                'id_cotizacion' => $cotizacion->id_cotizacion,
                'numero_referencia' => $cotizacion->numero_referencia,
                'incoterm' => $cotizacion->incoterm,
